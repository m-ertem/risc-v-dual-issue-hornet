...
#
# project_twopipe_difmem_dualiss.tcl: Tcl script for re-creating project 'project_twopipe_difmem_dualiss'
#
# Generated by Vivado on Mon Sep 23 20:47:15 +0300 2024
...
#
# 1. This project restoration tcl script (project_twopipe_difmem_dualiss.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/core/ALU.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/core/muldiv/MULDIV_ctrl.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/core/muldiv/MULDIV_in.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/core/muldiv/MULDIV_top.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/core/muldiv/MUL_DIV_out.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/core/control_unit.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/new/core_0.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/new/core_1.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/core/core_wb.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/core/csr_unit.v"]"\
 ...
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/new/inst_mem_rw_wb.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/new/issue_unit.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/core/load_store_unit.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/peripherals/loader_wb.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/peripherals/mtime_registers_wb.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/core/muldiv/multiplier_32.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/new/pc_logic.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/new/reg_bank.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/peripherals/uart_wb.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/processor/fpga_uart/fpga_top.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/core/core.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/lib/uart.h"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/processor/barebones/barebones_wb_top.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/peripherals/debug_interface_wb.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/processor/barebones/barebones_top_tb.v"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/test/aes/aes.h"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/imports/RISC-V-main/lib/irq.h"]"\
 "[file normalize "$origin_dir/../archive_project_summary.txt"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.xci"]"\
 "[file normalize "$origin_dir/../project_twopipe_difmem_dualiss.srcs/sim_1/imports/project_1_2/barebones_top_tb_behav.wcfg"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "project_twopipe_difmem_dualiss"
...
set script_file "project_twopipe_difmem_dualiss.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../../project_twopipe_difmem_dualiss"]"
...
# Create project
create_project -force ${_xil_proj_name_} ../../${_xil_proj_name_} -part xc7a50tcsg324-1
...
set obj [get_filesets sim_1]
set_property -name "top" -value "barebones_top_tb" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a50tcsg324-1 -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a50tcsg324-1 -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
