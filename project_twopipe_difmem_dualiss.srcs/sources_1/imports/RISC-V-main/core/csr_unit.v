...
module csr_unit(input clk_i,
                input reset_i,
                input [31:0] pc_i, // pipeline_0
                input [11:0] csr_r_addr_i, //CSR read address - pipeline_0
                input [11:0] csr_w_addr_i, //CSR write address - pipeline_0
                input [31:0] csr_reg_i, //CSR input - pipeline_0
                input csr_wen_i, //CSR write enable - pipeline_0
                input meip_i, //machine external interrupt - core_wb
                input mtip_i, //machine timer interrupt - core_wb
                input msip_i, //machine software interrupt - core_wb
                input [15:0] fast_irq_i, //fast interrupts - pipeline_0
                input take_branch_i, // pipeline_0
                input mem_wen_i, //MEM stage write enable signal - pipeline_1
                input ex_dummy_i_0,
                input ex_dummy_i_1,
                input mem_dummy_i_0, 
                input mem_dummy_i_1,
                input mret_id_i, // pipeline_0
                input mret_wb_i, // pipeline_0
                input misaligned_ex, // pipeline_1
                input instr_access_fault_i, // core_wb
                input illegal_instr_i, // pipeline_0
                input instr_addr_misaligned_i, // pipeline_0
                input ecall_i, // pipeline_0
                input ebreak_i, // pipeline_0
                input data_err_i, // core_wb_in

                output reg [31:0] csr_reg_o, // pipeline_0
                output [31:0] irq_addr_o, mepc_o, // pc_logic
                output mux1_ctrl_o, mux2_ctrl_o, // pc_logic
                output reg ack_o, // core_wb output
                output csr_if_flush_o_0, csr_id_flush_o_0, csr_ex_flush_o_0, csr_mem_flush_o_0,
                output csr_if_flush_o_1, csr_id_flush_o_1, csr_ex_flush_o_1, csr_mem_flush_o_1
                ); // both pipelines
...
wire csr_if_flush_0, csr_id_flush_0, csr_ex_flush_0, csr_mem_flush_0;
wire csr_if_flush_1, csr_id_flush_1, csr_ex_flush_1, csr_mem_flush_1;
...
assign csr_if_flush_0 = (`mstatus_mie & pending_irq) | (STATE == S1) | (mret_id_i & ~take_branch_i) | pending_exception;
assign csr_id_flush_0 = csr_ex_flush_0 | (`mstatus_mie & pending_irq) | pending_exception;
assign csr_ex_flush_0 = csr_mem_flush_0 | (`mstatus_mie & pending_irq & !ex_dummy_i_0) | instr_addr_misaligned_i;
assign csr_mem_flush_0 = (`mstatus_mie & pending_irq & !mem_dummy_i_0) | instr_access_fault_i;

assign csr_if_flush_1 = csr_if_flush_0;
assign csr_id_flush_1 = csr_id_flush_0;
assign csr_ex_flush_1 = csr_mem_flush_1 | (`mstatus_mie & pending_irq & !ex_dummy_i_1 & !misaligned_ex) | instr_addr_misaligned_i;
assign csr_mem_flush_1 = (`mstatus_mie & pending_irq & mem_wen_i & !mem_dummy_i_1) | instr_access_fault_i;
...
assign csr_if_flush_o_0 = csr_if_flush_0;
assign csr_id_flush_o_0 = csr_id_flush_0;
assign csr_ex_flush_o_0 = csr_ex_flush_0;
assign csr_mem_flush_o_0 = csr_mem_flush_0;
assign csr_if_flush_o_1 = csr_if_flush_1;
assign csr_id_flush_o_1 = csr_id_flush_1;
assign csr_ex_flush_o_1 = csr_ex_flush_1;
assign csr_mem_flush_o_1 = csr_mem_flush_1;
