...
assign inst_wb_dat_i_1 = wb_dat_o[5]; // we added
...
core_wb #(.reset_vector(32'h7400))
    corewb(.reset_i(reset), //active-low reset
          .clk_i(clk_i),
          ...
          .inst_wb_dat_i_1(inst_wb_dat_i_1), // we added
...
inst_mem_rw_wb #(.ADDR_WIDTH(13))
  inst_memory(.port0_wb_cyc_i(wb_cyc_i[0]),
              ...
              .port0_wb_dat_o_1(wb_dat_o[5]), // we added 
              .port0_wb_err_o(wb_err_o[0]),
              .port0_wb_rst_i(wb_rst_i[0]),
              .port0_wb_clk_i(wb_clk_i[0]));
              
dat_mem_rw_wb #(.ADDR_WIDTH(13))
  dat_memory(.port1_wb_cyc_i(wb_cyc_i[1]),
